...
func assetsClientPageHtml() (*asset, error) {
	path := "/home/user/ngrok/assets/client/page.html"
...
func assetsClientStaticCssBootstrapMinCss() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/css/bootstrap.min.css"
...
func assetsClientStaticCssHighlightMinCss() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/css/highlight.min.css"
...
func assetsClientStaticImgGlyphiconsHalflingsPng() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/img/glyphicons-halflings.png"
...
func assetsClientStaticJsAngularSanitizeMinJs() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/js/angular-sanitize.min.js"
...
func assetsClientStaticJsAngularJs() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/js/angular.js"
...
func assetsClientStaticJsBase64Js() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/js/base64.js"
...
func assetsClientStaticJsHighlightMinJs() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/js/highlight.min.js"
...
func assetsClientStaticJsJquery191MinJs() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/js/jquery-1.9.1.min.js"
...
func assetsClientStaticJsJqueryTimeagoJs() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/js/jquery.timeago.js"
...
func assetsClientStaticJsNgrokJs() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/js/ngrok.js"
...
func assetsClientStaticJsVkbeautifyJs() (*asset, error) {
	path := "/home/user/ngrok/assets/client/static/js/vkbeautify.js"
...
func assetsClientTlsNgrokrootCrt() (*asset, error) {
	path := "/home/user/ngrok/assets/client/tls/ngrokroot.crt"
